...
def generate_relationship_notes_with_llm(
    ...
    result = {var: data.notes for var, data in response.relationships.items()}
...
def load_or_generate_relationship_notes(
    ...
    if config.show_input_data:
        print(f"  ✓ Relationship notes carregadas: {len(relationship_notes)} variáveis anotadas")
